...
The servo motor has four cables. The orange one (analog feedback) you plug into A0 of the Wemos. The white data cable you plug into D0. I don't supply the power for motor via the microcontroller, because it only gives up to 500mA via the pins, but the motor could overload this, by drawing up to 1800mA when it turns. The power for the motor and microcontroller comes from the power supply, which outputs 5V. To make the four cables fit to the 2 connectors, I feed + and - through each of the wago terminals and put a jumper cable in there. Then I screwed the respective jumper cables (red: + and black: -) to the power supply by replacing the end with cable lugs.
